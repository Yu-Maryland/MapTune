...
temp_blif = "/export/mliu9867/LibGame/temp_blifs_ucb/" + design[:-5] + "_temp.blif"
lib_path = "/export/mliu9867/LibGame/gen_newlibs_ucb/"
...
class UCB_MAB:
  ...
  def select_action(self):
    ...
    # Exploitation (choose remaining based on UCB)
